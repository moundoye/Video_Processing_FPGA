...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../elimax_ghrd_nios_sys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is elimax_ghrd_nios_sys
SOPC_NAME := elimax_ghrd_nios_sys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x410a0
SOPC_SYSID_FLAG += --sidp=0x410a0
ELF_PATCH_FLAG  += --sidp 0x410a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1581096736
SOPC_SYSID_FLAG += --timestamp=1581096736
ELF_PATCH_FLAG  += --timestamp 1581096736
